    ...
    return (
        <div id="" className="pb-2 col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="grid mx-auto text-sm font-medium ">
                <div>{MyMultiSelectCategorias()}</div>
                <div className="flex justify-end pt-1 ">
                    <button
                        type="button"
                        onClick={filterPostOff}
                        className="btn-hover bg-[#9d5b5b] mr-1 text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                        Quitar Filtros
                    </button>
                    <button
                        type="button"
                        onClick={filterPost}
                        className="btn-hover bg-[#9d5b5b] text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                        Filtrar
                    </button>
                </div>
            ...
            <div className="px-3">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        placeholder="La mejor chaza ..."
                        required
                    />
                    <button
                        type="button"
                        onClick={searchButton}
                        className="btn-hover bg-[#9d5b5b] text-white absolute right-2.5 bottom-2.5  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                        Buscar
                    </button>
                </div>

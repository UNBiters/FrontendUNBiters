    ...
    async function deletePost(id) {
        ...
        try {
            ...
            const response = await client.delete(
                `publications/deleteMyPublication/${card.id}`,
                {
                    headers: {
        ...
        <div className={className}>
            ...
            <div className="newpost col-span-2 flex justify-end px-3 min-[650px]:grid-cols-1">
                <NewPost
                    ...
                    onClose={() => {
                        router.push("/unbiters/profile/posts", { scroll: false });
                        setIsOpen(false);
                    }}
                ></NewPost>
            </div>
            ...
            {isOpenDelete && (
                <Delete
                    message={"Borrar publicación"}
                    onClose={() => {
                        router.push("/unbiters/profile/posts", { scroll: false });
                        setIsOpenDelete(false);
                    }}
                    onRedirect={() => {
                        deletePostUp(card._id);
                        router.push("/unbiters/profile/posts", { scroll: false });
                        setIsOpenDelete(false);
                    }}
                />
            ...
            <div
                id={card._id}
                className="relative flex  max-w-[28rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg"
            >
                {mode == "edit" ? (
                ...
                <div className="px-5 py-2">
                    <div className="flex items-center justify-between mb-3">
                        <h5 className="block font-sans text-xl antialiased font-medium leading-snug tracking-normal text-blue-gray-900">
                            {card.chaza && card.user
                                ? names.filter((item) => item.id == card.chaza)[0].nombre
                                : card.nombreChaza}
                        </h5>
                ...
                <div className="px-5 pb-3 grid grid-cols-2 gap-4 content-center">
                    <div>
                        <button
                            onClick={onClick}
                        ...
                        >
                            <div className="flex px-8 items-center justify-between">
                                ...
                                <span className={fillText + " font-bold text-lg"}>
                                    {likes}
                                </span>
                            </div>
                        </button>
                    ...
                    <div>
                        {mode == "edit" ? (
                            <Link
                                href={"/unbiters/profile/posts/?id=" + card._id}
                                scroll={false}
                                type="button"
                                className="block w-full select-none rounded-lg bg-pink-500 py-3.5 px-7 text-center align-middle font-sans text-sm font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                            >
                    ...
                    <div className="col-span-2">
                        <p className="text-end block font-sans text-base antialiased font-light leading-relaxed text-gray-700">

    ...
    return (
        <>
            ...
            <div class="mt-2 bg-white relative  mx-4  flex justify-between gap-x-6 p-5 rounded-md">
                ...
                <div class="pt-10 hidden sm:flex sm:flex-col sm:items-end">
                    ...
                    <p class="mt-1 text-clip text-xs leading-5 text-gray-500"><time datetime="">{moment(comment.createdAt, "YYYYMMDD").format('LL')}</time></p>

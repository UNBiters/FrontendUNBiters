        ...
        <div className={className}>
            <div className="max-w-lg bg-white text-center border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <Link href={`?id=` + card._id} type="button" className=""><div class="relative mx-4 mt-4 overflow-hidden text-white shadow-lg rounded-xl bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40">
                    ...
                    <Link
                        href={"/unbiters/profile?" + card._id} target='_blanck'
                    ...
                    <div className="text-center font-normal text-gray-700 dark:text-gray-400">
                        ...
                        <div className='grid grid-cols-1 sm:grid-cols-2'>
                            <div>
                                <ul>
                                    ...
                                    <li class="flex justify-center">
                                        <Link href={"/unbiters/profile?" + card._id} target='_blanck' className="text-sm font-normal text-gray-700">
                                            UNBiters
                                        </Link>
                                    </li>
                                    {card.redesSociales ? card.redesSociales.map((redesSociales) => (

                                        <li key={card.redesSociales.indexOf(redesSociales)} class="flex justify-center">
                                            <Link href={redesSociales} target='_blanck' className="text-sm font-normal text-gray-700">
                                                {redesSociales}
                                            </Link>
                                        </li>
                                    )) : null}
                            ...
                            <div>
                                <ul>
                                    ...
                                    {card.mediosPagos ? card.mediosPagos.map((mediosPagos) => (
                                        <li key={card.mediosPagos.indexOf(mediosPagos)} class="flex justify-center">

                                            <span key={card.mediosPagos.indexOf(mediosPagos)} className="text-sm font-normal text-gray-700">
                                                {mediosPagos}
                                            </span>
                                        </li>
                                    )) : null}
                        ...
                        <div class="pt-2  px-2">
                            ...
                            {card.categorias ? card.categorias.map((categorias) => (
                                ...
                                <span key={"re" + categorias.indexOf(categorias)} class="inline-block bg-[#9d5b5b] rounded-full px-3 py-1 text-sm font-semibold text-gray-900 mr-2 mb-2">#{categorias}</span>

      ...
      >
        <div className="pt-44 flex justify-center items-center">
          <div className=" max-w-sm mx-auto bg-[#F6EEDF] rounded-xl shadow-md overflow-hidden ">
            ...
            {!errors ?
              errors.map((err) => (
                <div key="e" id="alert-2" class="flex items-center p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
            ...
            <div className="md:flex md:flex-col md:items-center p-5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div class="pb-2 flex items-center w-full">
                  <label for="checked-checkbox" class="mr-2 text-md font-semibold text-gray-900 dark:text-gray-300">Marca esta casilla si eres una chaza</label>

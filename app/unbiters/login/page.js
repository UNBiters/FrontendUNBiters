        ...
        <div className="containerLogin flex justify-center items-center">
            <div className="max-w mx-auto bg-[#F6EEDF] rounded-xl shadow-md overflow-hidden md:max-w-2xl">
                <div className="md:flex md:flex-col md:items-center p-10">
                    ...
                    <a href="#" className="block mt-1 text-md leading-tight font-medium text-black hover:underline">Al continuar aceptas los terminos y
                    ...
                    <Button href='#' className='px-5 mx-1 bg-[#d63447] shadow-xl'>
                        Iniciar Sesión
                    </Button>

                    <hr className="border-t border-red-500 border-2 my-4" style={{ width: '90%' }} />

                    <Button href='#' className='px-5 mx-1 mb-4 bg-[#F5F5F5] text-balck shadow-xl w-full' style={{ width: '70%' }}>
                        <img className='mr-3 lg:h-6 sm:h-6' src='/images/GoogleLogo.png'></img>
                        Iniciar Sesión con Google
                    </Button>
                    <Button href='#' className='px-5 mx-1 bg-[#F5F5F5] text-balck shadow-xl w-full' style={{ width: '70%' }}>
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="basis-10"><a href="#" className="block mt-1 text-md leading-tight font-bold text-black hover:underline">Registrate</a></div>
                    </div>
                </div>
            </div>
        </div>
